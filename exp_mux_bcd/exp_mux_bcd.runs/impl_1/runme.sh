...
HD_PWD='C:/Users/arthu/OneDrive/Documentos/Vivado/exp_mux_bcd/exp_mux_bcd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_completo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_completo.tcl -notrace
