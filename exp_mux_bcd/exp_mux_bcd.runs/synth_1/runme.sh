...
HD_PWD='C:/Users/arthu/OneDrive/Documentos/Vivado/exp_mux_bcd/exp_mux_bcd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_completo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_completo.tcl
