...
HD_PWD='C:/Users/arthu/OneDrive/Documentos/Vivado/calculadora/calculadora.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soma.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soma.tcl -notrace
