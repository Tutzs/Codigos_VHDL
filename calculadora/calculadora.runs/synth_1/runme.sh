...
HD_PWD='C:/Users/arthu/OneDrive/Documentos/Vivado/calculadora/calculadora.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soma.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soma.tcl
