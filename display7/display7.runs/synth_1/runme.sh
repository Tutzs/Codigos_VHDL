...
HD_PWD='C:/Users/Soous/Documents/Vivado/display7/display7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_compe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_compe.tcl
