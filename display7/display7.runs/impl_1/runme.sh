...
HD_PWD='C:/Users/Soous/Documents/Vivado/display7/display7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_compe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCD_compe.tcl -notrace
