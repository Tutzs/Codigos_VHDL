...
HD_PWD='C:/Users/arthu/OneDrive/Documentos/Vivado/Somador/Somador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log subtrator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source subtrator.tcl
