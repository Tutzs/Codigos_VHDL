...
HD_PWD='C:/Users/arthu/OneDrive/Documentos/Vivado/Somador/Somador.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log subtrator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source subtrator.tcl -notrace
